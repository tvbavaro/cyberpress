            ...
            <template v-else>
                ...
                <div class="slider">
                    <div class="slider__wrapper">
                        <div class="slider__list" ref="slider">
                    ...
                    <div class="slider__nav-wrapper">
                        <button class="slider__arrow" :class="{ 'slider__arrow_unactive': isStartPosition }"
                            @click="scrollSlideTo('slider', -1)"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
...
export default {
    ...
    mounted() {
        this.$refs.slider.addEventListener('scroll', this.setSliderArrowsStyle);
    },
    beforeUnmount() {
        this.$refs.slider.removeEventListener('scroll', this.setSliderArrowsStyle);
    },
    computed: {
        ...mapState({
